...
class ContactProvider with ChangeNotifier {
  List<Contact> _contactList = []; // Full list of contacts
...
// Filtered list
  ...
  List<Contact> get contactList => _filteredContactList.isEmpty ? _contactList : _filteredContactList;
  ...
  void searchContactByName(String query) {
    if (query.isEmpty) {
